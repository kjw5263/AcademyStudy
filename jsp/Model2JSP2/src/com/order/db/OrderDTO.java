...
public class OrderDTO {
	...
	private String o_trade_num;		// 상품주문번호(1234-1234, 5356-2421...)
	
	private int o_g_num;			// 주문된 상품 번호 
	private String o_g_name;		// 주문된 상품 이름
	private int o_g_amount;			// 주문된 상품 수량
	private String o_g_size;		// 주문된 상품 사이즈
	private String o_g_color;		// 주문된 상품 색상
	private String o_m_id;			// 주문자 아이디
	
	private String o_receive_name;	// 받는 사람 이름
	private String o_receive_addr1; // 받는 사람 주소1
	private String o_receive_addr2; // 받는 사람 주소2
	private String o_receive_phone; // 받는 사람 연락처
	private String o_receive_msg;	// 배송 요청 사항'
	
	private int o_sum_money;		// 주문 총액
	
	private String o_trade_type;	// 주문 유형 (카카오, 신용, 계좌...)
	private String o_trade_payer;	// 결제자
	private Date o_trade_date;		// 주문 날짜
	
	private String o_trans_num;		// 운송장 정보
	private Date o_date;			// 주문 테이블 시간 정보
