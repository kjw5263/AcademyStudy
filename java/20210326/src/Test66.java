/*
	this() 메소드 -> 같은 클래스의 다른 생성자 호출 시 사용
...
class MyDate {
	...
	// 객체 생성시.. 객체 변수 year, month, day의 값을 저장할 생성자
...
public class Test66 {
	...
	public static void main(String[] args) {
		...
		// 3. 객체 생성 동시에 1998을 생성자 호출시 매개변수로 전달
		// 생성한 객체 내부의 객체변수(인스턴수 변수)들에 각각 저장
		MyDate d3 = new MyDate(1998);
		d3.print();
		
		
		// 4. 객체 생성 시 기본 생성자 호출하여 각 객체변수들의 값들 초기화 (저장)
