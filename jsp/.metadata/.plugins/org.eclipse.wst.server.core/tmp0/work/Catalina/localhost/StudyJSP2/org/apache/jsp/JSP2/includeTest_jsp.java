 ...
 * Generated at: 2021-03-30 07:33:35 UTC
...
public final class includeTest_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.put("/JSP2/color.jspf", Long.valueOf(1617089301666L));
  }
  ...
  String col3 = "grey";
      ...
      out.write("\t\t컴파일 되기 전에, 소스코드를 결합 후 컴파일을 함 (1개의 파일로 생성) <br><br>\r\n");
      out.write("\t\t\t=> 페이지에서 사용될 공통의 값 (변수) <br>\r\n");
      out.write("\t\t\r\n");
      out.write("\t\t2) {jsp:inlcude page=\"\"}{/jsp:include} (JSP 액션태그) <br>\r\n");
      out.write("\t\t액션태그 : 태그를 사용해서 다른 동작(jsp)을 실행가능한 코드의 형태 (jsp코드처럼 쓰이는 코드) <br>\r\n");
      out.write("\t\t각각의 파일을 컴파일 후, 해당 코드에 추가(여러개의 파일이 추가된 1개의 파일)\r\n");
      out.write("\t\t\t=> 특정 페이지를 해당 페이지에 추가할 때 <br>\r\n");
      out.write("\t\t\r\n");
      out.write("\t</h4>\r\n");
      out.write("\t\r\n");
      ...
      out.write("\r\n");
      out.write("\t\t\t\t<!-- include가 top을 부를때 값을 넘겨주고, top은 그 데이터를 받아 출력하기 -->\r\n");
      out.write("\t\t\t\r\n");
      out.write("\t\t\t</td>\r\n");
      out.write("\t\t</tr>\r\n");
      out.write("\t\t<tr>\r\n");
      ...
      out.write("\t\t\t\t<img src=\"3.jpg\" width=\"400\" height=\"400\">\r\n");
      out.write("\t\t\t</td>\r\n");
      out.write("\t\t</tr>\r\n");
      out.write("\t\t<tr>\r\n");
      out.write("\t\t\t<td colspan=\"2\" height=\"100\">\r\n");
